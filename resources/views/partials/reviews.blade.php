    ...
    <div class="mx-auto max-w-2xl px-4 py-4">
        <div>
            ...
            <div class="mt-10">
                ...
                <p class="mt-1 text-sm text-gray-600">Enjoyed your experience with this traveler? Share your thoughts with the rest of the community.</p>

                <a href="#" class="mt-6 inline-flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-8 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 sm:w-auto">Write a review</a>
            </div>
        </div>
