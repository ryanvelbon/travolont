      ...
      <div class="mt-10 xl:mt-0">
        ...
        <form class="mt-6 sm:flex sm:max-w-md">
          ...
          <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
            <button type="submit" class="flex w-full items-center justify-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">Subscribe</button>
          </div>
        </form>
      </div>
    </div>
    <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
      <div class="flex space-x-5 md:order-2">
        <a href="https://www.instagram.com/travolont/">
          <i class="fa-brands fa-instagram fa-2xl hover:text-primary-600"></i>
        </a>
        <a href="https://www.tiktok.com/@travolont">
          <i class="fa-brands fa-tiktok fa-2xl hover:text-primary-600"></i>
        </a>
        <a href="https://twitter.com/travolont">
          <i class="fa-brands fa-twitter fa-2xl hover:text-primary-600"></i>
        </a>
        <a href="https://www.reddit.com/r/travolont/">
          <i class="fa-brands fa-reddit fa-2xl hover:text-primary-600"></i>
        </a>
        <a href="https://id.pinterest.com/travolont/">
          <i class="fa-brands fa-pinterest fa-2xl hover:text-primary-600"></i>
        </a>
      </div>
